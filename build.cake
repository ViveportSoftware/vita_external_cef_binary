...
var cefWithChromiumBranchName = EnvironmentVariable("CEF_WITH_CHROMIUM_BRANCH_NAME") ?? "5735";
...
var cefWithMsvsVcRedistVersion = EnvironmentVariable("CEF_WITH_MSVS_VC_REDIST_VERSION") ?? "14.36.32532";
var cefWithMsvsVcToolsVersion = EnvironmentVariable("CEF_WITH_MSVS_VC_TOOLS_VERSION") ?? "14.36.32532";
var cefWithMsvsVersion = EnvironmentVariable("CEF_WITH_MSVS_VERSION") ?? "2022";
...
var cefWithWinSdkVersion = EnvironmentVariable("CEF_WITH_WIN_SDK_VERSION") ?? "10.0.22621.0";
...
var cefAutomateGitCommitIdMap = new Dictionary<string, string>
{
        ...
        { "5359", "60ee4a34aa542005901114b8bfe8b891b3873f38" },
        ...
        { "5735", "400fbf78399986dc3ac4c6acf25953a5496617b3" }
};
